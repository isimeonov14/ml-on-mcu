...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "mfccmodel"
...
#define AI_NETWORK_IN_1_HEIGHT      (156)
#define AI_NETWORK_IN_1_WIDTH       (13)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (2028)
#define AI_NETWORK_IN_1_SIZE_BYTES  (8112)
